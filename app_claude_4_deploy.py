...
def generate_answer(user_input: str, system_user_prompt: str, stream: bool = False, temperature: float = 0.8) -> str:
...
if send_button and user_input.strip():
    ...
    answer = generate_answer(user_input, system_user_prompt, temperature=0.8)
